  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={cn(
          "w-full relative text-sm sm:text-base z-10 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-10 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-100 bg-black dark:bg-zinc-900 dark:disabled:bg-[#1f1f1f] transition duration-200 flex items-center justify-center"
      >
        <motion.svg
